describe("Content and SEO", () => {
  ...
  it("should have proper page title", () => {
    cy.title().should(
      "eq",
      "Dave Henderson - Experienced Typescript Engineer, Manchester, UK"
    );
  });
  ...
  it("should display correct personal information", () => {
    ...
    cy.get("main").within(() => {
      cy.contains(
        "I'm Dave, A quaint Yorkshireman living in Manchester"
      ).should("be.visible");
  ...
  it("should have call-to-action section", () => {
    cy.contains("Always happy for a chat! Why not drop me a line?").should(
      "be.visible"
    );
